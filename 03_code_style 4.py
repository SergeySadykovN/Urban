# -*- coding: utf-8 -*-
'''
1. Переименуйте переменные, которые названы не в соответствии со стилем кода
2. Добавьте пробелы в коде в соответствии со стилем кода (подчеркивания желтым)
3. Добавьте отступы в коде в соответствии со стилем кода (подчеркивания желтым)
4. Получившийся файл прикрепите для оценки домашнего задания'''
# блоки кода
